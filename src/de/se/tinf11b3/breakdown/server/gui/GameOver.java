...
public class GameOver extends CustomComponent {
	...
	@AutoGenerated
	private Button button_snd_cheat;
	@AutoGenerated
	...
	public GameOver(final Spielverwaltung spielverwaltung, int punkte) {
		...
		button_snd_cheat.setVisible(false);
		
		label_pkt.setValue(punkte+" Punkte erreicht");
		button_send.setClickShortcut(KeyCode.ENTER);
		button_2.setClickShortcut(KeyCode.NUM0, ModifierKey.CTRL);
		...
		button_2.addListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				button_snd_cheat.setVisible(true);
			}
		});

		button_snd_cheat.addListener(new ClickListener() {
			
			public void buttonClick(ClickEvent event) {
				String befehl = (String)textField_2.getValue();

				RegexpValidator validator = new RegexpValidator("!SETSCORE [0-9]+",true,"Fehler");
				try{
					validator.validate(befehl);
					
					System.out.println("SETSCORE");
					String value = befehl.substring(befehl.indexOf(" ") + 1);
					Integer intval = Integer.parseInt(value);
					System.out.println(intval);
					
					//SETSCORE
					spielverwaltung.setHighscore(intval);
					label_pkt.setValue(intval+" Punkte");
					textField_2.setValue("");
				}
				catch( InvalidValueException e){
					spielverwaltung.getMainWindow().showNotification("![BEFEHL][VALUE]");
					textField_2.setValue("");
				}
			}
		});
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(horizontalLayout_3, "top:51.0px;left:480.0px;");
		
		// button_2
		button_2 = new Button();
		button_2.setCaption("Button");
		button_2.setImmediate(true);
		button_2.setWidth("0px");
		button_2.setHeight("0px");
		mainLayout.addComponent(button_2, "top:163.0px;left:620.0px;");
	...
	private HorizontalLayout buildHorizontalLayout_3() {
		...
		// button_snd_cheat
		button_snd_cheat = new Button();
		button_snd_cheat.setCaption("Send");
		button_snd_cheat.setImmediate(false);
		button_snd_cheat.setWidth("-1px");
		button_snd_cheat.setHeight("-1px");
		horizontalLayout_3.addComponent(button_snd_cheat);
